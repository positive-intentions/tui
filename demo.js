...
import { Container, Row, Column, Card, Heading, Paragraph, Label, Status, TextField, PasswordField, EmailField, TextArea, NumberField, Select, Button, IconButton, } from "./src/index.js";
let renderer = null;
const options = [
...
export async function run() {
    ...
    selectComponent.onItemSelected((index, option) => {
